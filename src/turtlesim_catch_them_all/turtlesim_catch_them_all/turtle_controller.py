...
class TurtleControllerNode(Node):
    def __init__(self):
        ...
        self.catch_closet_turtle_first_ = self.get_parameter("catch_closest_turtle_first").value
    ...
    def callback_alive_turtles(self,msg):
        if len(msg.turtles) > 0: #if there is no turtle
            if self.catch_closet_turtle_first_:
                ...
                for turtle in msg.turtles:
                    ...
                    if closest_turtle_ == None or distance < closest_turtle_distance:
